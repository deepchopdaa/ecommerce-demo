...
export default function ProductTable() {
    ...
    const handleSave = async (data) => {
        ...
        const url = editMode
            ? `${process.env.NEXT_PUBLIC_API_URL}/seller/product/${updateid}`
            : "${process.env.NEXT_PUBLIC_API_URL}/seller/product";
        ...
        setSnack({
            ...
            severity: res?.product ? "success" : "error",
        });
            ...
            <div className="p-4">
                ...
                <br></br>
                {
                    products.length > 0 ?
                        ...
                        : <Typography variant="h5" color="secondary" sx={{ textAlign: "center" }}>Product Not Added , Add New Product</Typography>
                }
                {/* Create / Edit Modal */}
                    ...
                    <form onSubmit={handleSubmit(handleSave)}>
                        <DialogContent>
                            ...
                            <StyledFormControl fullWidth margin="dense" sx={inputStyle} error={!!errors.category}>
                                ...
                                >
                                    {brach?.map((branch) => (
                                        <MenuItem key={branch?._id} value={branch?._id} sx={{
                                            fontWeight: branch?.primary ? 700 : 400,
                                        }}>
                                            {branch?.branchName}
                                        </MenuItem>
                                    ))}
